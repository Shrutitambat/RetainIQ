    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-xl font-bold text-[var(--text-primary)] mt-2">Welcome back</h2>
          <p className="text-[var(--text-secondary)] text-xs mt-1">Sign in to manage your customer retention</p>
        </div>
